...
//         </p>
//         <blockquote className="text-xl italic font-medium text-gray-600 mb-12">
...
//         <h2 className="text-4xl font-bold mb-6 text-gray-800">About Adam Connors</h2>
//         <p className="text-lg leading-relaxed mb-10">
